...
- Versão: a cada release, atualizar `version` em `package.json` (semver) e acrescentar a entrada em `CHANGELOG.md`; a app mostra versão + commit + data de build (ver `src/lib/version.ts`).
