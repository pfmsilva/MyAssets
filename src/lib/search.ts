...
const PAGES: Page[] = [
  ...
  { title: "Ativos", href: "/ativos", words: "contas carteiras ppr cripto dinheiro" },
  { title: "Evolução", href: "/historico", words: "historico grafico evolucao patrimonio" },
  { title: "Despesas", href: "/despesas", words: "gastos custos categorias poupanca" },
  { title: "Orçamento", href: "/orcamento", words: "limites orcamento budget mensal" },
  { title: "Rentabilidade", href: "/rentabilidade", words: "twr xirr ganho retorno performance" },
