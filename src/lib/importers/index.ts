...
export const IMPORTERS = {
  ...
  binance: { label: "Binance (ativos .csv)", accept: ".csv", needsBalance: false, needsDate: true, parse: async (buf: ArrayBuffer) => parseBinance(new TextDecoder("utf-8").decode(buf)) },
