...
export function QuoteRefresh({ assetId, quotesAt, quoted, quotable, error }: { assetId: string; quotesAt: string | null; quoted: number; quotable: number; error: string | null }) {
