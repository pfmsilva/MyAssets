      ...
      <div className="grid gap-4 lg:grid-cols-5">
        ...
        <Card title="Como obter os ficheiros" className="lg:col-span-2 text-sm text-ink-2">
          <ul className="list-inside list-disc space-y-1">
            ...
            <li><b>Binance</b>: CSV com uma linha por moeda. Aceita dois formatos: com o <i>valor atual em EUR</i>, ou com os <i>símbolos do Yahoo</i> (par em euros e par em dólares, ex.: <code>SUI20947-EUR</code>) e sem valor — nesse caso o valor de cada moeda é calculado com a cotação do momento (par em euros e, na falta dele, par em dólares ao câmbio). Em ambos, a quantidade e o valor de compra estimado dão o preço médio e o ganho/perda, e as posições ficam cotadas em direto pelo Yahoo.</li>
